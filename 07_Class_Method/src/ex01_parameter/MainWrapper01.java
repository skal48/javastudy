...
public class MainWrapper01 {
  ...
  public static void ex05(int[] arr) { //인수가 배열 1개이면 파라미터 int[] arr을 선언한다. 배열이름은 아무 이름이나 사용해도 상관없다. 
    System.out.println("ex05 : " + Arrays.toString(arr));
  }
  
  public static void ex04(String name, int age) { // 문자열 인수는 파라미터 String name으로 받고 정수형 인수는 파라미터 int로 받는다.  
