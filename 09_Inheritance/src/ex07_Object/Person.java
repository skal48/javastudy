...
/*
 * java.lang.Object 클래스  //java.lang  -- 패키지 이름
 * 1. 모든 클래스의 최상위 슈퍼클래스이다. 
 * 2. 별도의 슈퍼 클래스를 명시하지 않은 클래스들은(extends가 없는 클래스) 모두 Object 클래스의 서브클래스이다.
 * 3. 모든 것을 저장할수 있는 자바의 만능 타입이다. 
 * 4. Object 타입으로 저장하면 Object클래스의 메소드만 호출 할 수 있다. 이를 해결하기 위해서 "반드시" 캐스팅을 해야 한다. 
 *   
 */

/* object 슈퍼 클래스는 참조값(주소)을 비교함 
 *  ┌--------------┐
 *  │    Object    │ 슈퍼 클래스
 *  │--------------│
 ...
 *  │--------------│
 *  │  @Override   │
 *  │  equals()    │ 이름과 나이가 같으면 true, 아니면 false 반환 (equals는 하드코딩하지 않고 자동완성한다.)
 *  │              │
 *  │   @Override  │
