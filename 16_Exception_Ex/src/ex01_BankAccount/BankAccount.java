...
public class BankAccount {
   ...
   * @param money 출금할 금액
   * @return 실제로 출금된 금액
   * @throws RuntimeException 출금할 금액이 0보다 작거나 잔액보다 클 경우 발생한다.  
   */
   ...
   * @param you 다른계좌
   * @param param  이체할 금액
   * @throws RuntimeException 입금 메소드와 출금메소드가 던진 예외를 다시 던진다. 
   */
  public void transfer(BankAccount you, long param) throws RuntimeException {
    //한줄이다.   
    
      you.deposit( withdrawal(param));
